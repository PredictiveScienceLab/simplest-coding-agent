...
- 2026-03-25: Added a dedicated `%env OPENAI_API_KEY=...` cell before the final C++ agent example so generated-agent tests use the notebook environment without exposing a real key in the repo.
